...
Page({
    ...
    goPay: function (e) {
        ...
        that.data.e = e
        that.setData({
            showPayTypeFlag: !that.data.showPayTypeFlag
        })
    },
    radioChange(e) {
        this.setData({
    ...
    selectPayTypeYes: function () {
        let that = this
        if (that.data.payType == 'WECHAT_PAY') {
            that.payNowByWx(that.data.e)
        } else {
            that.payNowByBalance(that.data.e)
        }
